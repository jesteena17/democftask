...
<cfparam name="form.arrivalYear" default="">
<cfparam name="form.site" default="">
<cfparam name="form.FiletoUpload" default="">
<cfparam name="form.dollar" default="">
<cfparam name="form.cents" default="">
<cfparam name="form.cfname" default="">
<cfparam name="form.clname" default="">
<cfparam name="form.cemail" default="">
<cfparam name="form.cphone1" default="">
<cfparam name="form.cphone2" default="">
<cfparam name="form.cphone3" default=""> 
<html>
    <head>
        ...
        <cfoutput>
               ...
               <cfif structKeyExists(form,"sub")  >
                         ...
                         <cfinvoke component="t23" method="storeemployeeinfo" returnvariable="result">
                              ...
                              <cfinvokeargument name="resumefile" value="#fileresult.serverFile#" />
